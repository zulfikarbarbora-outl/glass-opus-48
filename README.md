...
Opus 48 kbps preview MP3s for the **glass** sample library.
...
- **Files**: 153 Opus previews
- **Bitrate**: 48 kbps VBR
- **Container**: Ogg Opus (.opus)
- **Source**: [`zulfikarbarbora-outl/glass`](https://github.com/zulfikarbarbora-outl/glass)
- **Branch**: `main`

## URL pattern

```
https://raw.githubusercontent.com/zulfikarbarbora-outl/glass-opus-48/main/<filename>.opus
```
